...
export default async function WorkspaceSettingsPage() {
  ...
  return (
    <section>
      ...
      <div className="mt-7 rounded-[26px] border border-white/[0.09] bg-[var(--dashboard-control)] shadow-sm/82 p-5 sm:p-7">
        <p className="mb-6 flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.15em] text-[var(--dashboard-accent)]">
